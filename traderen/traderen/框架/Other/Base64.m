...
- (NSString *)authCode:(NSString *)auth_key operation:(NSStringAuthCode)operation encoding:(NSStringEncoding)encoding
{
    ...
    NSString * keyA = [[NSString stringWithFormat:@"%@",[key substringWithRange:NSMakeRange(0,16)]] md5];
    ...
    NSString * cryptkeyab = [[NSString stringWithFormat:@"%@%@",keyA,keyC] md5];
    NSString * cryptkey = [NSString stringWithFormat:@"%@%@",keyA,cryptkeyab];
    NSInteger cryptkey_lenght = cryptkey.length;
